...
import dictlib
import cherrypy
from reactor import json4human
from reactor.core import log, server, trace
from reactor.core import exceptions
...
class AuthService(object):
    """AuthService base across all reactor core service objects"""
    conf = None
    _slack = None
    server = None
