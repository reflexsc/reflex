...
"""
General reactor module and controls
"""
...
from reactor import crypto
import ujson as json

# find the reactor base install folder based on this lib
...
class Base(Colorize):
    ...
    def __inherit__(self, base):
        ...
        self.DEBUG("reactor.Base.__inherit__(base={0})".format(base))
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.DEBUG("reactor.Base.__init__()")
    ...
    def cfg_load(self):
        ...
        try:
            ...
            cfg_path = os.environ['HOME'] + '/.reactor/cfg'
            if os.path.exists(cfg_path):
                ...
                self.DEBUG("No .reactor/cfg", module='config')

            # then pull environment settings, as they have higher priority
            self._env2cfg('REACTOR_URL')
            self._env2cfg('REACTOR_TOKEN')
            self._env2cfg('REACTOR_SECRET')
            self._env2cfg('REACTOR_APIKEY')
    ...
    def cfg_secret(self):
        ...
        site_key_file = os.environ.get('REACTOR_SITE_KEY')
    ...
    def cfg_get(self, name, default=None, required=False):
        ...
        ...
        ValueError: ZZZZZZ not defined (in environ or reactor settings)
        """
        if name in os.environ.keys():
            ...
            raise ValueError(name + " not defined (in environ or reactor settings)")
        else:
            return ''
